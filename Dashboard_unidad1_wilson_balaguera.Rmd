...
**Carrera Luz 2022** En esta carrera  con una distancia de 10km , se recibieron participantes desde los 15 año s en adelante , en ella participaron 
```{r}
paste("Atletas femeninos:",length(subset_femenino$timerun))
paste("Atletas masculinos:",length(subset_masculino$timerun))
...
Si bien la categoria de Jovenes es mas rapida , los veteranos de Categoria "c" en conjunto son mas rapidos
...
dat=aggregate(bd$timerun/60, list(categoria =bd$categoria), FUN=mean) 
names (dat)[2]='Promedio Tiempo'
dat
